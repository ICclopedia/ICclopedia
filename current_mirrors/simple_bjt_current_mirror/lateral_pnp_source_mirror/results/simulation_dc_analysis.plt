...
unset logscale y 
set yrange [4.005000e+01:6.095000e+01]
#set xtics 1
#set x2tics 1
#set ytics 1
#set y2tics 1
set format y "%g"
set format x "%g"
plot 'lateral_pnp_current_mirror_simulation_dc_analysis.data' using 1:2 with lines lw 1 title "(v2#branch*1e+06)"
set terminal push
set terminal postscript eps color noenhanced
set out 'lateral_pnp_current_mirror_simulation_dc_analysis.eps'
replot
set term pop
replot
