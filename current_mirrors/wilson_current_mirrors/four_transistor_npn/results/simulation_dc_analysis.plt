...
set format y "%g"
set format x "%g"
plot 'four_transistor_modified_wilson_bjt_current_mirror_simulation_dc_analysis.data' using 1:2 with lines lw 1 title "(v2#branch*-1e+06)"
set terminal push
set terminal postscript eps color noenhanced
set out 'four_transistor_modified_wilson_bjt_current_mirror_simulation_dc_analysis.eps'
replot
set term pop
replot
